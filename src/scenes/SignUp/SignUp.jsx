...
//       <div className="logo-icon-singup">
//         <img src={images.logo} alt="Logo" className="logo-singup" />
//       </div>
...
//         ) : (
//           <div>
//             <input type="text" placeholder="Enter Verification Code" onChange={(e) => setCode(e.target.value)} required />
